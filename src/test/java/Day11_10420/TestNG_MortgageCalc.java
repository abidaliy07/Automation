...
public class TestNG_MortgageCalc {
    ...
    public void setDriver() throws IOException, BiffException {
        ...
        readableFile = Workbook.getWorkbook(new File("src/main/resources/Excel_Selenium.xls"));
    ...
    public void getMonthlyPayment() throws WriteException, InterruptedException {
        ...
        for(int i = 1; i < rowCount; i++) {
            ...
            //select the month
            Reusable_Methods.dropDown(driver, "//*[@name='param[start_month]']", startMonth, "Start Month");
            //enter start year
